...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		vertex++;
		t[vertex * 2 + 0] = 0.4375 + raio2 * sin(i * delta);
		t[vertex * 2 + 1] = 0.1875 + raio2 * cos(i * delta);
		n[vertex * 3 + 0] = 0;
		n[vertex * 3 + 1] = 1.0f;
		n[vertex * 3 + 2] = 0;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.4375 + raio2 * sin((i + 1) * delta);
		t[vertex * 2 + 1] = 0.1875 + raio2 * cos((i + 1) * delta);
		n[vertex * 3 + 0] = 0;
		n[vertex * 3 + 1] = 1.0f;
		n[vertex * 3 + 2] = 0;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.8125 + raio2 * sin((i + 1) * delta);
		t[vertex * 2 + 1] = 0.1875 + raio2 * cos((i + 1) * delta);
		n[vertex * 3 + 0] = 0.0f;
		n[vertex * 3 + 1] = -1.0f;
		n[vertex * 3 + 2] = 0.0f;
		...
		vertex++;
		t[vertex * 2 + 0] = 0.8125 + raio2 * sin(i * delta);
		t[vertex * 2 + 1] = 0.1875 + raio2 * cos(i * delta);
		n[vertex * 3 + 0] = 0.0f;
		n[vertex * 3 + 1] = -1.0f;
		n[vertex * 3 + 2] = 0.0f;
